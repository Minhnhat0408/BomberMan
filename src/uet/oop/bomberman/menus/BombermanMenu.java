...
import static uet.oop.bomberman.BombermanGame. auto;
...
public class BombermanMenu {
    ...
    public void updateSideBar() {
        ...
        if(bomberman.isAutopilot()) {
            auto.setText("AI: ON");
        }else{
            auto.setText("AI: OFF");
        }
        if(bomberman.isBoosted()) {
            enemy.setText("Boost: " + (10 - bomberman.getPowerTime().getElapsedTime()/1000));
        }else{
            enemy.setText("Boost: 0");
        }
    }
    ...
    public void nextLevel() {
        ...
        enemy = new TextInGame("Boost: ", 460);
